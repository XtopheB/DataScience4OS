...
# Select 5-10 random points to show residuals
# Get extreme points both above and below the line
sample_points <- data %>%
  slice_max(residual, n = 2) %>%      # 4 highest (above line)
  bind_rows(
    data %>% slice_min(residual, n = 6)  # 4 lowest (below line)
  )
```
