...
subtitle: "Data Science for Official Statistics - Daejeon"
...
```{r , include=FALSE}
write_csv(data, "Data/Household.csv")
```
...
**Question:**  
> What determines the level of `income` for households?
...
data <- data %>%
  mutate(predicted = predict(modelMulti),
