...
Child marriage is a form of gender-based violence and manifestations of gender inequality (placement under goal 5). This practices are typically upheld by tradition and social norms but prohibited by national legislation in some countries. SDG indicator 5.3.1 track the prevalence of practices and progress towards their elimination.

## Definition:

SDG Indicator 5.3.1 measures the proportion of women aged 20–24 who were first married or in a union before age 18 (or 15). 

Formula: 
$$
SDG_{5.3.1} =  \frac{\text{number of women aged 20–24 who were married before age 18}}{\text{total number of women aged 20–24}}  \times  100
$$
**Remarks:**

- Covers both formal unions (marriages) and informal unions (cohabitation)
- SDG indicator captures only child marriage among **girls**.


## Read the data

Our data set being in the directory `Data`, we need to specify the right path when loading the data. Here the data are in SPSS format ($.sav$) and we need a specific package  (*haven*) to load the data. 
...
## Online download
# urlfile <- "https://raw.githubusercontent.com/XtopheB/DataScience4OS/main/Data/wm_Lao_2017.sav"
