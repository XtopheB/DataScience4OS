...
The variable *Principle_Export* list all the types of goods exported from Esdeegia. There are **``r length(unique(TradeData$Principle_Exports))`** different goods exported. Let's have the list of all these goods. 
  ...
  ggplot(aes(x = reorder(Principle_Exports, total), y = (total))) +  
    geom_bar(stat = "identity", color="white", fill= "lightsteelblue1") +
      labs( x= "Exports categories", 
            y = "Vatu", 
            title = paste("Exports from Esdeegia, year = ", MyYear),
