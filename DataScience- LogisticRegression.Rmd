...
urlfile <-"Data/wmmics.csv"

# or Online download
# urlfile <- "https://raw.githubusercontent.com/XtopheB/DataScience4OS/main/Data/wmmics.csv"

data_raw <- read_csv(urlfile)
...
library(stargazer)
## Just for output in slides

stargazer(model1, 
          type = "latex",  # vs "html"
          title = "Logistic Regression Results",
          dep.var.labels = "Domestic Violence",
          covariate.labels = c("Urban", "Age", "Vocational", "University",
...
modelsummary(model1,stars = TRUE, 
             ...
             coef_rename = c(
               ...
               "windexSecond" = "Second Quintile",
               "windexMiddle" = "Middle Quintile",
               "windexFourth" = "Fourth Quintile",
               "windexRichest" = "Richest Quintile",
               "MAMarried/Partnered" = "Married/Partnered"
             ))
```
...
1. **Education**: Higher education levels show 
2. **Wealth**: Wealth index shows 
3. **Residence**: Urban/rural differences
4. **Marital Status**: 

The logistic regression models indicate that 
