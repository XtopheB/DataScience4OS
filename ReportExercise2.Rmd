...
The variable *Principle_Export* list all the types of goods exported from Esdeegia. There are **YYYY** different goods exported. Let's have the list of all these goods. 
