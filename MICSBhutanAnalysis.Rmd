...
## Online download
# urlfile <- "https://raw.githubusercontent.com/XtopheB/DataScience4OS/main/Data/MICSBhutan/hh.sav"
...
# Keeping only useful
df <-df %>%
  select(age, WAGEM, region,  welevel, wealth, WAGEM, MA1, HH7, HH1, wmweight)
```
...
We will use the DHS survey at the individual level and construct a binary response variable indicating whether there was **marriage before 18 years** old (or "*girl's marriage*"). We will try to understand which factor**S** may affect the probability to observe girl's marriage, and in particular whether, after controlling for the usual individual factors such as education, wealth and other socioeconomic factors, there is also an impact of environmental factors.   
